...
import '../../style/checkout-component/checkout-form.css'

export function CheckoutForm(){
    const [option_payment, setPayment] = useState("e-money")

    const handleChange = (e) => {
        setPayment(e.target.value)
    }

    const emoney_method = <div className="form-input-container">
            <div className="form-input">
                        <label>e-Money Number</label><br></br>
                        <input name="money-number" placeholder="238521993"/>
            </div>
            <div className="form-input">
                        <label>e-Money PIN</label><br></br>
                        <input name="money-pin" placeholder="6891"/>
            </div>
        </div>

    const cash_method = <div className="cash-info">
    ...
    const payment_method = (option_payment == "e-money") ? emoney_method : cash_method
    ...
    return <div id="checkout-form">
        ...
        <form method="post">
            <div className="form-section">
                ...
                <div className="form-input-container">
                    <div className="form-input">
                        ...
                        <input name="submitted-name" autoComplete="name" placeholder="Charlie Best"/>
                    </div>
                    <div className="form-input">
                        <label>Email Address</label><br></br>
                        <input name="submitted-email" autocomplete="email" placeholder="charlie.best@mail.com"/>
                    </div>
                    <div className="form-input">
                        <label>Phone Number</label><br></br>
                        <input name="submitted-number" autocomplete="number" placeholder="+1 202-555-0136"/>
                    </div> 
                </div>
            </div>
            ...
            <div className="form-section">
                <h3>Shipping Info</h3>
                <div className="form-input-container">
                    <div className="form-input form-input-plain">
                        <label>Address</label><br></br>
                        <input name="submitted-address" autocomplete="address" placeholder="1137 Williams Avenue"/>
                    </div>
                    <div className="form-input">
                        <label>ZIP Code</label><br></br>
                        <input name="submitted-zip" autocomplete="zip" placeholder="10001"/>
                    </div>
                    <div className="form-input">
                        <label>City</label><br></br>
                        <input name="submitted-city" autocomplete="city" placeholder="New York"/>

                    </div>
                    <div className="form-input">
                        <label>Country</label><br></br>
                        <input name="submitted-country" autocomplete="country" placeholder="United States"/>
                    </div>
                </div>
            </div>

            <div className="form-section">
                <h3>Payment détails</h3>
                <div className="form-input-container form-input-radio-container">
