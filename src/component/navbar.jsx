...
import { Overview } from './overview-products';

export function Navbar(){
    const [dropdown_visibility, setVisibility] = useState("hidden")
    ...
    const handleClick = () => {
        if (dropdown_visibility == "hidden") setVisibility("block")
        else setVisibility("hidden")
    }

    return( <>
        <nav>
            <div id='nav-list' className="dropdown" onClick={handleClick}>       
                <svg className="dropdown-button" onClick={handleClick} width="16" height="15" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF" fillRule="evenodd"><path d="M0 0h16v3H0zM0 6h16v3H0zM0 12h16v3H0z"/></g></svg>
            </div>                 
            ...
            <div class="nav-link-container" id="navbar-link-container">
                {nav_link_container}
            </div>
        ...
        <div className={`dropdown-content ${dropdown_visibility}`}>
            <Overview/>
        </div>
        </>
    )
